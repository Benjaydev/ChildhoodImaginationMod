...
public class FireEasterChickenRenderer extends EasterChickenRenderer{
    public FireEasterChickenRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(EasterChickenEntity easterChickenEntity) {
        return new ResourceLocation(ChildhoodImaginationMod.MODID, "textures/entity/fire_easter_chicken.png");
    }
