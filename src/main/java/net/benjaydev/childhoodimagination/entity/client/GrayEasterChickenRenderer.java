...
public class GrayEasterChickenRenderer extends EasterChickenRenderer{
    public GrayEasterChickenRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(EasterChickenEntity easterChickenEntity) {
        return new ResourceLocation(ChildhoodImaginationMod.MODID, "textures/entity/gray_easter_chicken.png");
    }
}
