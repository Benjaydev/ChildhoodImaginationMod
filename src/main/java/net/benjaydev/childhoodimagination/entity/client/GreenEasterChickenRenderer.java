...
public class GreenEasterChickenRenderer extends EasterChickenRenderer{
    public GreenEasterChickenRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public ResourceLocation getTextureLocation(EasterChickenEntity easterChickenEntity) {
        return new ResourceLocation(ChildhoodImaginationMod.MODID, "textures/entity/green_easter_chicken.png");
    }
}
